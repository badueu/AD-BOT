...
DEFAULT_CONFIG = {
    "host_usernames": ["amirali_2607"],
    "admin_usernames": ["amirali_2607"],
    "vip_usernames": [],
    "banned_users": [],
    "teleport_locations": {
    ...
    "language": "fa",
    "welcome_message": "سلام {username} خوش اومدی👋🏻 امیدوارم لحظات خوبی رو در اینجا سپری کنید",
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "69145a7b20106674db6c600e")
    api_token = os.getenv("API_TOKEN", "d09d71a47ff641a4e10900bc646eb6ebf203926ad4346130aaf0ba502664c05e")
